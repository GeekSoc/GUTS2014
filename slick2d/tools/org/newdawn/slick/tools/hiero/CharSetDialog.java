...
public class CharSetDialog extends JDialog {
		...
		save.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					x.printStackTrace();
					JOptionPane.showMessageDialog(CharSetDialog.this,
							"Failed to resave character set");
				}
			}
		});
			...
			public void actionPerformed(ActionEvent e) {
				try {
					String name = JOptionPane.showInputDialog(
							CharSetDialog.this,
							"Enter a name for the new Chararater Set:");
					set.setName(name);
	...
	public class CharsPanel extends JPanel {
		 ...
		 *            The y position
		 * @param updateIfSame
		 *            True if we should update if it's the same as the last
		 *            update
		 */
