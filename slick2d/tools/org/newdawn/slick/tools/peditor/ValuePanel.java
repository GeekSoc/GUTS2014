...
public class ValuePanel extends DefaultPanel {
	 ...
	 * @param linearEnabled
	 *            True if this range should be able to be set to linear
	 */
	 ...
	 * 
	 * @param linear
	 *            True if this vlaue is set to give linear random numbers
	 */
	 ...
	 * 
	 * @param listener
	 *            The listener to be notified of updates to this panel
	 */
