...
/**
 * The common bits between all the different control panels. This gives a way to
 * link controls to data elements within the emitter. Plumbing it this way saves
 * the effort of writing bespoke code for each editor type/
 *
 * @author kevin
 */
public abstract class ControlPanel extends DefaultPanel implements
		InputPanelListener {
	 ...
	 * @param valuePanel
	 *            The panel used to set the value in the emitter
	 */
	 ...
	 *            The name of the control
	 * @param minMax
	 *            The panel used to set the range in the emitter
	 */
	 ...
	 * 
	 * @param range
	 *            The configurable range from the emitter
	 * @param name
	 *            The name of the component to link to
	 */
	 ...
	 * 
	 * @param value
	 *            The configurable value from the emitter
	 * @param name
	 *            The name of the component to link to
	 */
	...
	public void minMaxUpdated(MinMaxPanel source) {
		...
		if (range != null) {
			...
			throw new RuntimeException(
					"No data set specified for the GUI source");
		}
	}
