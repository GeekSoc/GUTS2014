...
public class EmitterList extends JPanel {
	 ...
	 * 
	 * @param editor
	 *            The editor to report updates to
	 */
	public EmitterList(final ParticleEditor editor) {
		...
		add.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				editor.addEmitter(new ConfigurableEmitter("NewEmitter_"
						+ System.currentTimeMillis()));
			}
		});
		remove.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ConfigurableEmitter emitter = (ConfigurableEmitter) list
						.getSelectedValue();
				if (emitter != null) {
		...
		list.addListSelectionListener(new ListSelectionListener() {
			public void valueChanged(ListSelectionEvent e) {
				editor.setCurrentEmitter((ConfigurableEmitter) list
						.getSelectedValue());
			}
		});
