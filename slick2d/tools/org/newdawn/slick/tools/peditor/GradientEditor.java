...
public class GradientEditor extends JPanel {
	 ...
	 * 
	 * @param listener
	 *            The listener to be notified on change of this editor
	 */
	...
	private void editPoint() {
		...
		Color col = JColorChooser
				.showDialog(this, "Select Color", selected.col);
		if (col != null) {
			selected.col = col;
			repaint(0);
			fireUpdate();
	 ...
	 * @param col
	 *            The color at the new control point
	 */
