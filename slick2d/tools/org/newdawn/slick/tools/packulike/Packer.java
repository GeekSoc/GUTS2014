...
public class Packer extends JFrame {
	...
	public Packer() {
		...
		chooser.setFileFilter(new FileFilter() {
			public boolean accept(File f) {
				...
				return (f.getName().endsWith(".png")
						|| f.getName().endsWith(".jpg") || f.getName()
						.endsWith(".gif"));
			}
				...
				if (resp == JFileChooser.APPROVE_OPTION) {
					...
					for (int i = 0; i < selected.length; i++) {
						try {
							...
							x.printStackTrace();
							JOptionPane.showMessageDialog(Packer.this,
	 ...
	 * 
	 * @param x
	 *            The x coordinate to look for the sprite
	 * @param y
	 *            The y coordinate to look for the sprite
	 * @return The sprite found at the given location or null if no sprite can
	 *         be found
	 */
	 ...
	 * 
	 * @param selection
	 *            The series of sprites to be selected (Sprite objects)
	 */
