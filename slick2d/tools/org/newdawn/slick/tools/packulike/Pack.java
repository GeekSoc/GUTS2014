...
public class Pack {
	 ...
	 * 
	 * @param files
	 *            The list of file objects pointing at the images to be packed
	 * @param width
	 *            The width of the sheet to be generated
	 * @param height
	 *            The height of the sheet to be generated
	 * @param border
	 *            The border between sprites
	 * @param out
	 *            The file to write out to
	 * @return The generated sprite sheet
	 * @throws IOException
	 *             Indicates a failure to write out files
	 */
	public Sheet pack(ArrayList files, int width, int height, int border,
	 ...
	 * 
	 * @param images
	 *            The list of sprite objects pointing at the images to be packed
	 * @param width
	 *            The width of the sheet to be generated
	 * @param height
	 *            The height of the sheet to be generated
	 ...
	 *             Indicates a failure to write out files
	 */
	public Sheet packImages(ArrayList images, int width, int height,
			int border, File out) throws IOException {
		...
		try {
			...
			if (out != null) {
				pout = new PrintStream(new FileOutputStream(new File(
						out.getParentFile(), out.getName() + ".xml")));
				pout.println("<sheet>");
			}
