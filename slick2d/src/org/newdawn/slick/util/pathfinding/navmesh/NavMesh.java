 ...
 * shapes are linked together allow path finding but without the high resolution
 * that tile maps require. This leads to fast path finding and potentially much
...
public class NavMesh {
	...
	/**
	 * Optimize a path by removing segments that arn't required to reach the end
	 * point
	 * 
	 * @param path
