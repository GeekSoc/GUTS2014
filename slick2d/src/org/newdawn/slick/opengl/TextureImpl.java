...
public class TextureImpl implements Texture {
	 ...
	 * @param textureBuffer
	 *            The texture buffer containing the data for the texture
	 */
	...
	private class ReloadData {
		...
		public int reload() {
			...
			return InternalTextureLoader.get().reload(TextureImpl.this,
					srcPixelFormat, componentCount, minFilter, magFilter,
					textureBuffer);
		}
	}
}